...
function splitEvenlyOnItem(values, item, weightRight, offset) {
    if (weightRight === void 0) { weightRight = true; }
    if (offset === void 0) { offset = 0; }
    var leftLength = getLengthOfHalfOfArray_(values, !weightRight) - offset;
    var rightLength = getLengthOfHalfOfArray_(values, weightRight) + offset;
...
exports.splitEvenlyOnItem = splitEvenlyOnItem;
