...
var Carousel = (function () {
    ...
    Carousel.prototype.updateClasses_ = function (activeSlide) {
        ...
        var removeProblemClasses = function (slide) {
            beforeClasses.forEach(function (problemClass) { return remove_class_if_present_1.removeClassIfPresent(slide, problemClass); });
            afterClasses.forEach(function (problemClass) { return remove_class_if_present_1.removeClassIfPresent(slide, problemClass); });
        };
        slidesBefore
