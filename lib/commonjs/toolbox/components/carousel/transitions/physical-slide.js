...
var PhysicalSlide = (function () {
    ...
    PhysicalSlide.getHalves_ = function (carousel, targetSlide, slideDifference) {
        if (carousel.allowsLooping()) {
            return split_evenly_on_item_1.splitEvenlyOnItem(carousel.getSlides(), targetSlide, true, slideDifference);
        }
        else {
    ...
    PhysicalSlide.prototype.adjustSplit_ = function (carousel, target, adjustment) {
        ...
        var slideDifference = carousel.getSlideIndex(activeSlide) - carousel.getSlideIndex(targetSlide);
        var halves = PhysicalSlide.getHalves_(carousel, targetSlide, slideDifference);
