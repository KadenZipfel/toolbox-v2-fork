...
var PhysicalSlide = (function () {
    function PhysicalSlide(_a) {
        ...
        this.dragAdjustments_ =
            dynamic_default_1.DynamicDefaultMap.usingFunction(function () { return zero_vector_2d_1.ZERO_VECTOR_2D; });
    ...
    PhysicalSlide.prototype.adjustSplit_ = function (carousel, target, adjustment) {
        ...
        if (target !== null && carousel.allowsLooping()) {
            ...
            if (Math.abs(distanceFromCenter) > (totalWidth / 2)) {
                ...
                this.dragAdjustments_.set(carousel, new vector_2d_1.Vector2d(xTranslation, 0));
            }
            this.adjustSlides_(targetSlide, [targetSlide], 1, this.dragAdjustments_.get(carousel));
        }
