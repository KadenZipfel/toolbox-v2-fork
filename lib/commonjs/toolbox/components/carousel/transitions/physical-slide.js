...
var PhysicalSlide = (function () {
    ...
    PhysicalSlide.prototype.adjustSlides_ = function (targetSlide, slides, distancesFromTarget, direction) {
        var _this = this;
        ...
        slides.forEach(function (slide) {
            ...
            var difference = targetOffset - (distance * direction);
            if (difference !== 0) {
                _this.draggableBySlide_.get(slide)
