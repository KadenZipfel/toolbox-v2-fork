...
var get_common_offset_ancestor_1 = require("../../utils/dom/position/get-common-offset-ancestor");
...
var Sticky = (function () {
    ...
    Sticky.prototype.init_ = function () {
        ...
        this.commonOffsetAncestor_ =
            get_common_offset_ancestor_1.getCommonOffsetAncestor(this.clone_, this.target_);
        this.measure_();
        this.renderLoop_();
    };
    ...
    Sticky.prototype.measure_ = function () {
        ...
        var cloneDistanceFromAncestor = get_visible_distance_between_elements_1.getVisibleDistanceBetweenElements(this.clone_, this.commonOffsetAncestor_);
