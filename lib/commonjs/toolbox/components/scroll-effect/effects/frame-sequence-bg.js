...
var FrameSequenceBg = (function () {
    ...
    FrameSequenceBg.prototype.loadNextImage_ = function () {
        ...
        load_image_1.loadImage(frameUrl)
            .then(function () {
    ...
    FrameSequenceBg.prototype.run = function (target, distance, distanceAsPercent) {
        ...
        render_loop_1.renderLoop.scrollMutate(function () {
            set_styles_from_map_1.setStylesFromMap(_this.backFrame_, backFrameStyles);
            set_styles_from_map_1.setStylesFromMap(_this.frontFrame_, frontFrameStyles);
        });
    };
