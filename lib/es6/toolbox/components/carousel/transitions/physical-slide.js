...
var ZERO_VECTOR = new Vector2d(0, 0);
    ...
    PhysicalSlide.prototype.renderLoop = function (carousel) {
        ...
        renderLoop.measure(function () {
            if (!carousel.isBeingInteractedWith()) {
                ...
                else if (!_this.hasTransitionedTo(_this.getActiveSlide(carousel), carousel)) {
                    carousel.transitionToSlide(_this.getActiveSlide(carousel));
                }
                else {
